...
Vi ser att de ip-adresser som hade öppna portar var 192.168.177.129, 192.168.177.138, 192.168.177.139 och 192.168.177.155.
...
Då kan vi lista ut at generatorn g = 2, primtalet p = 1073741847. Vi ser också att "primtalet" är alldelser för litet, endast 30-bit, det måste vara betydligt mycket större för att vara säkert. Då vi har vi generatorn, primtalet och den publika nyckeln. Nu kan vi räkna ut den privata nyckeln genom en matematisk attack! För att knäcka Diskreta logaritmproblemet kan vi använda "BSGS-algoritmen". 
